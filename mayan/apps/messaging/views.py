...
class MessageMarkReadView(MultipleObjectConfirmActionView):
    ...
    pk_url_kwarg = 'message_id'
    post_action_redirect = reverse_lazy(viewname='messaging:message_list')
    success_message_single = _('Message "%(object)s" marked as read successfully.')
    success_message_singular = _('%(count)d message marked as read successfully.')
    success_message_plural = _('%(count)d messages marked as read successfully.')
