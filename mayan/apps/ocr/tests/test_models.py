...
from .literals import (
    TEST_DOCUMENT_VERSION_CONTENT, TEST_DOCUMENT_VERSION_CONTENT_DEU_1,
    TEST_DOCUMENT_VERSION_CONTENT_DEU_2
)
...
class DocumentOCRTestCase(GenericDocumentTestCase):
    ...
    def test_ocr_language_backends_eng(self):
        ...
        self.assertTrue(TEST_DOCUMENT_VERSION_CONTENT in content)
...
class GermanOCRSupportTestCase(GenericDocumentTestCase):
    ...
    def test_ocr_language_backends_end(self):
        ...
        self.assertTrue(
            TEST_DOCUMENT_VERSION_CONTENT_DEU_1 in content
        )
        self.assertTrue(
            TEST_DOCUMENT_VERSION_CONTENT_DEU_2 in content
        )
